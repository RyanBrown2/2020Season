...
public class Constants {
    ...
    public static class Drive {
        ...
        public static SpeedControllerGroup leftDrive = new SpeedControllerGroup(new CANSparkMax(leftDriveMotors[0], MotorType.kBrushless), new CANSparkMax(leftDriveMotors[1], MotorType.kBrushless));
		public static SpeedControllerGroup rightDrive = new SpeedControllerGroup(new CANSparkMax(rightDriveMotors[0], MotorType.kBrushless), new CANSparkMax(rightDriveMotors[1], MotorType.kBrushless));
    }
