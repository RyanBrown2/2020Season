 ...
 */
public class SynchronousPID extends Controller{
    ...
    private boolean m_reverseOutput = false;
...
//            m_totalError = 0;
    ...
    public void reverseOutput(boolean reverseOutput){
    	m_reverseOutput = reverseOutput;
    }
}
